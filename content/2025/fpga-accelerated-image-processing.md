---
title: FPGA-accelerated image processing
...
cover:
  alt: Preview of FPGA-accelerated image processing
  image: 2025/fpga-accelerated-image-processing/preview.png
...
- [Code](https://github.com/deluf/fpga-accelerated-image-processing)
- [Documentation](/2025/fpga-accelerated-image-processing/documentation.pdf)
...
{{< figure src="/2025/fpga-accelerated-image-processing/circuit-block-diagram.png" caption="Block diagram of the implemented circuit" >}}
...
{{< figure src="/2025/fpga-accelerated-image-processing/verification-main-circuit.png" caption="Waveform of the input and output ports of the circuit using a simple 2x3 test ROM" >}}
...
{{< twocolumns 20 >}}
	...
	{{< figure src="/2025/fpga-accelerated-image-processing/input-332.png" caption="Input image (`3-3-2` bitmap)" >}}

	{{< figure src="/2025/fpga-accelerated-image-processing/output-332.png" caption="Output image (`3-3-2` bitmap, `α = 0.500`)" >}}

	{{< figure src="/2025/fpga-accelerated-image-processing/input-grayscale.png" caption="Input image (grayscale)" >}}

	{{< figure src="/2025/fpga-accelerated-image-processing/output-grayscale.png" caption="Output image (grayscale, `α = 0.500`)" >}}
...
{{< figure src="/2025/fpga-accelerated-image-processing/timings.png" caption="Timings" >}}

{{< figure src="/2025/fpga-accelerated-image-processing/power.png" caption="Power consumption" >}}

{{< figure src="/2025/fpga-accelerated-image-processing/utilization.png" caption="Resource utilization" >}}
